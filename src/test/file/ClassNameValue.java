...
public class TheInternetLoginPage extends Base {
    ...
    private static final By USERNAME = By.className("class1 class2"); // Noncompliant
    private static final By PASSWORD = By.className("class1 class2 class3"); // Noncompliant
    private static final By SUBMIT = By.className("class1 class2 "); // Noncompliant
    private static final By CONFIRMATION_TEXT = By.cssSelector(".success");

    @FindBy(className = "class 1") // Noncompliant
    private WebElement searchBox;

    @FindBy(how = How.CLASS_NAME, using = "invalid class name") // Noncompliant
